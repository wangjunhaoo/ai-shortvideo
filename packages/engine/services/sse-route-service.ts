...
import { isErrorResponse, requireProjectAuthLight, requireUserAuth } from '@engine/api-auth'
import { type SSEEvent } from '@/lib/task/types'
import { getSharedSubscriber } from '@/lib/sse/shared-subscriber'
import { listActiveLifecycleSnapshot } from '@engine/services/sse-service'
...
export async function handleSseRequest(request: Request) {
