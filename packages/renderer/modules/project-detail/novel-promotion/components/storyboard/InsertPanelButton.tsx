...
interface InsertPanelButtonProps {
    ...
    disabled?: boolean
    labels: {
        insertHereTitle: string
        insertPanelLabel: string
    }
}

export default function InsertPanelButton({ onClick, disabled, labels }: InsertPanelButtonProps) {
    return (
        <button
            onClick={onClick}
            disabled={disabled}
