...
export interface StoryboardGroupHeaderLabels {
  moveUpTitle: string
...
export interface StoryboardGroupHeaderProps {
  labels: StoryboardGroupHeaderLabels
    ...
    <div className="flex items-center gap-4">
      ...
      <div>
        <h3 className="text-sm font-medium text-[var(--glass-text-secondary)]">
          {labels.segmentLabel}【{formatClipTitle(clip)}】
        </h3>
