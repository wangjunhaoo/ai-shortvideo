...
import type { CharacterCardGalleryLabels } from './types'
...
type CharacterCardGalleryProps =
  | {
    ...
    labels: CharacterCardGalleryLabels
  }
  | {
    mode: 'single'
    characterName: string
            ...
            <div key={originalIndex} className="relative group/thumb">
              ...
              >
                <MediaImageWithLoading
                  src={url}
                  alt={props.labels.optionAltLabel(props.characterName, originalIndex + 1)}
                ...
                >
                  <span>{props.labels.optionNumberLabel(originalIndex + 1)}</span>
                  {isThisSelected && (
