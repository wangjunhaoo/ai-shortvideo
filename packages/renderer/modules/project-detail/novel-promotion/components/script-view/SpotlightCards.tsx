...
export interface SpotlightCharCardLabels {
  removeConfirm: string
  removeTitle: string
  generateCharacterLabel: string
  noAudioLabel: string
  playingLabel: string
  listenLabel: string
}

export interface SpotlightLocationCardLabels {
  removeConfirm: string
  removeTitle: string
  generateLocationLabel: string
}
...
type SpotlightCharCardProps = {
  ...
  onRemove?: () => void
  labels: SpotlightCharCardLabels
}
        ...
        >
          {!hasVoice ? (
            ...
            <>
              ...
              <span>{labels.playingLabel}</span>
            </>
          ) : (
            <>
              <AppIcon name="play" className="w-3 h-3" />
              <span>{labels.listenLabel}</span>
            </>
          )}
        </button>
      </div>
...
type SpotlightLocationCardProps = {
  ...
  onOpenAssetLibrary?: () => void
  onRemove?: () => void
  labels: SpotlightLocationCardLabels
}
