...
import VideoTimelinePanel, {
} from '@renderer/modules/project-detail/novel-promotion/components/video-stage/VideoTimelinePanel'
import VideoRenderPanel from '@renderer/modules/project-detail/novel-promotion/components/video-stage/VideoRenderPanel'
import type { VideoStageShellProps } from '../runtime/types'
import {
...
import { useVideoTaskStates } from '../runtime/useVideoTaskStates'
import { useVideoPanelsProjection } from '../runtime/useVideoPanelsProjection'
import { useVideoPromptState } from '../runtime/useVideoPromptState'
import { useVideoPanelLinking } from '../runtime/useVideoPanelLinking'
import { useVideoVoiceLines } from '../runtime/useVideoVoiceLines'
import { useVideoDownloadAll } from '../runtime/useVideoDownloadAll'
import { useVideoStageUiState } from '../runtime/useVideoStageUiState'
import { useVideoPanelViewport } from '../runtime/useVideoPanelViewport'
import { useVideoFirstLastFrameFlow } from '../runtime/useVideoFirstLastFrameFlow'
...
} from '../runtime/immediate-video-submission'
import { useVideoStageI18n } from './useVideoStageI18n'

export type { VideoStageShellProps } from '../runtime/types'
          ...
          >
            <div className="space-y-1">
              <h3 className="text-lg font-semibold text-[var(--glass-text-primary)]">
                {batchConfigLabels.title}
              </h3>
              <p className="text-sm text-[var(--glass-text-tertiary)]">
                {batchConfigLabels.description}
              </p>
            </div>
            ...
            <ModelCapabilityDropdown
              ...
              placeholder={batchConfigLabels.modelPlaceholder}
            />
              ...
              >
                {isConfirming ? (
                  <>
                    ...
                    <span>{batchConfigLabels.confirmingLabel}</span>
                  </>
                ) : (
                  <span>{batchConfigLabels.confirmGenerateAllLabel}</span>
                )}
              </button>
            </div>
          </div>
