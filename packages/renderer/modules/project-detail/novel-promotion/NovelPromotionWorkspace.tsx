...
import { useNovelPromotionWorkspaceI18n } from './hooks/useNovelPromotionWorkspaceI18n'
...
function NovelPromotionWorkspaceContent(props: NovelPromotionWorkspaceProps) {
  ...
  const { runConsoleLabels, workspaceLabels } = useNovelPromotionWorkspaceI18n()
  ...
  if (showStoryToScriptMinBadge) {
    runBadges.push({
      id: 'story-to-script',
      label: runConsoleLabels.storyToScriptRunningLabel,
  ...
  if (showScriptToStoryboardMinBadge) {
    runBadges.push({
      ...
      label: runConsoleLabels.scriptToStoryboardRunningLabel,
      onClick: () => vm.execution.setScriptToStoryboardConsoleMinimized(false),
    })
  }

  if (!vm.project.projectData) {
    return <div className="text-center text-(--glass-text-secondary)">{workspaceLabels.loadingLabel}</div>
  }
  ...
  return (
    <div>
      ...
      <WorkspaceHeaderShell
        ...
        assetLibraryLabel={workspaceLabels.assetLibraryLabel}
        settingsLabel={workspaceLabels.settingsLabel}
        refreshTitle={workspaceLabels.refreshTitle}
      />
      ...
      <div className="pt-24">
        ...
        <WorkspaceAssetLibraryModal
          ...
          labels={{
            title: workspaceLabels.assetLibraryLabel,
          }}
        />
        ...
        {vm.execution.showCreatingToast && (
          <ProgressToast
            show
            message={workspaceLabels.creatingMessage}
        ...
        <ConfirmDialog
          ...
          confirmText={workspaceLabels.rebuildConfirmLabel}
          cancelText={workspaceLabels.rebuildCancelLabel}
