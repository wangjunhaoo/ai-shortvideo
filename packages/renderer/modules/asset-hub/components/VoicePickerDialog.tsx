...
import { useRendererGlobalVoices } from '@renderer/modules/asset-hub/hooks/useAssetHubQueries'
...
export interface VoicePickerDialogLabels {
    title: string
    empty: string
    cancel: string
    confirm: string
...
export default function VoicePickerDialog({ isOpen, onClose, onSelect, labels }: VoicePickerDialogProps) {
    const voicesQuery = useRendererGlobalVoices()
            ...
            >
                ...
                <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--glass-stroke-base)] bg-[var(--glass-bg-surface-strong)]">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold text-[var(--glass-text-primary)]">{labels.title}</h2>
                        </div>
